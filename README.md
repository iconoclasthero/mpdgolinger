...
Classic rock stations have long had gimmicks like "Twofer Tuesdays," "Double shots," "Workfoce blocks," etc., where multiple songs from [usually] the same artist were played consecutively. That's essentially what this does. Set your limit=_n_ and mpd playback will linger on the playlist for _n_ songs before advancing on random to another block. This is compatible with consume and repeat playback modes (single mode would be nonsensical).
